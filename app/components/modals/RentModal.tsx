...
const RentModal = () => {
	...
	const onSubmit: SubmitHandler<FieldValues> = data => {
		...
		axios
			...
			.then(() => {
				toast.success('Listing creted successfully');
				router.refresh();
				reset();
	...
	if (step === STEPS.INFO) {
		bodyContent = (
			<div className="flex flex-col gap-8">
				<Heading title="Share some basics about you place" subtitle="What amenities do you have?" />
				<Counter
					title="Guests"
	...
	if (step === STEPS.PRICE) {
		bodyContent = (
			<div className="flex flex-col gap-8">
				<Heading title="Now, set your price" subtitle="How much" />
				<Input
					id="price"
					label="Price"
					formatPrice
